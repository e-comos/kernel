...
void idt_init(void) {
    ...
    GATE_IST(8,  isr8);  GATE(9,  isr9);  GATE(10, isr10); GATE(11, isr11);
    GATE_IST(12, isr12); GATE_IST(13, isr13); GATE_IST(14, isr14); GATE(15, isr15);
    ...
    GATE_IST(32, irq0);  GATE_IST(33, irq1);  GATE_IST(34, irq2);  GATE_IST(35, irq3);
    GATE_IST(36, irq4);  GATE_IST(37, irq5);  GATE_IST(38, irq6);  GATE_IST(39, irq7);
    GATE_IST(40, irq8);  GATE_IST(41, irq9);  GATE_IST(42, irq10); GATE_IST(43, irq11);
    GATE_IST(44, irq12); GATE_IST(45, irq13); GATE_IST(46, irq14); GATE_IST(47, irq15);
